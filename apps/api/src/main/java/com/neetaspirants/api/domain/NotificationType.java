...
/**
 * Kept general on purpose. REPLY / UPVOTE / MENTION / FOLLOW are the only types with a
 * real trigger in the product today. COMMUNITY_INVITE, ROOM_INVITE and ANNOUNCEMENT are
